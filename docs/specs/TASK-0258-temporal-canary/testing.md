...
- TASK-0258 focused suite: `200 passed` (including the local simulation command,
...
- Full repository pytest after the admission/terminal-loader hardening: `2,068 passed, 5
  skipped, 15 warnings`.
