#!/usr/bin/env python3
"""Merge the LAL–ORL Game 3 MViT augmentation into the base artifact."""
...
def main() -> int:
    base = verify_video_embedding_artifact(_read(BASE))
    extra = verify_video_embedding_artifact(_read(OUT / "mvit_extra_v1.json"))
    ...
    sealed = seal_video_embedding_artifact(merged)
    output = OUT / "mvit_merged_v1.json"
