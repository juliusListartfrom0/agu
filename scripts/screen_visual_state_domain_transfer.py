#!/usr/bin/env python3
"""Screen same-backbone Basketball-51 assistance on reviewed AGU games."""
...
from app.analysis.visual_state_domain_screen import (  # noqa: E402
    build_visual_state_domain_screen,
)
...
def run_screen(
    *,
    ...
    artifact = build_visual_state_domain_screen(
        source_embedding_artifact=_read_json(source_embeddings_path),
        target_embedding_artifact=_read_json(target_embeddings_path),
...
def main() -> None:
    ...
    artifact = run_screen(
        source_embeddings_path=arguments.source_embeddings,
        target_embeddings_path=arguments.target_embeddings,
