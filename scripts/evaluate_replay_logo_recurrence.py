#!/usr/bin/env python3
"""Evaluate an offline replay-logo proxy on clear live/replay dev windows."""
...
from app.analysis.replay_transition import evaluate_replay_logo_proxy  # noqa: E402
...
def main() -> int:
    ...
    metrics = evaluate_replay_logo_proxy(
        labels=label_payloads,
        evidence=evidence_payloads,
        minimum_precision=args.minimum_precision,
    )
    artifact = {
        "schema_version": "agu.replay-logo-proxy-evaluation.v1",
        "purpose": "offline_development_replay_proxy_rejection",
